      ...
      <Metadata title="Tools" description="Tools I Use" />
        <div className="toolsSection">
          ...
          <h3 class="htools">Kindle</h3>
            ...
            <h3 class="htools">Logitech K750 solar-powered, wireless keyboard</h3>
            ...
            <h3 class="htools">Logic Pro X</h3>
