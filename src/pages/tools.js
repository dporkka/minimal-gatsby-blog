    ...
    <Layout>
      <Metadata title="Tools" description="Tools I Use" />
        <div className="toolsSection">
            ...
            <a className="tools"><h3 className={styles.htools}>Nikon d3400</h3></a>
            <p>Entry level DSLR camera that takes decent pics</p>

            <a className="tools"><h3 className={styles.htools}>Kindle</h3></a>
            ...
            <a className="tools" ><h3 className={styles.htools}>HP 25f external monitor</h3></a>
            ...
            <a className="tools" ><h3 className={styles.htools}>Rav External Power Pack</h3></a>
