  ...
  return (
    ...
    <nav className={footerStyles.navContainer}>
      <ul className={footerStyles.navList}>
          ...
          <li>
            <Link to="/tools/" activeClassName={footerStyles.activeMenuItem}>
              Tools
            </Link>
          </li>
          <br></br>
