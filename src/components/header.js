      ...
      <nav className={headerStyles.navContainer}>
        <ul className={headerStyles.navList}>
          ...
          <li className={headerStyles.dropdown}>
            <a activeClassName={headerStyles.activeMenuItem}>
              More 
            ...
            <ul className={headerStyles.dropdownList}>
              <li>
                <a href="/projects/" tabindex="6" activeClassName={headerStyles.activeMenuItem}>
                  Projects
                </a>
              </li>
              <li>
                <a href="/tools/" tabindex="7" activeClassName={headerStyles.activeMenuItem}>
                  Tools
                </a>
              </li>
            </ul>
